...
var today_default = ".today-badge {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-family: var(--font-interface, inherit);\n  font-size: 0.85rem;\n  font-weight: 600;\n  letter-spacing: 0.05em;\n  color: var(--secondary, #3a3637);\n  background: var(--highlight, rgba(143, 159, 169, 0.15));\n  padding: 0.25rem 0.6rem;\n  border-radius: 6px;\n  border: 1px solid var(--lightgray, #e5e5e5);\n  line-height: 1.2;\n}\n.today-badge .today-prefix {\n  font-weight: 700;\n  opacity: 0.9;\n}\n.today-badge .today-date {\n  font-variant-numeric: tabular-nums;\n}";

// src/components/scripts/today.inline.ts
var today_inline_default = `function o(){document.querySelectorAll(".today-component [data-today='true']").forEach(t=>{let e=new Date,n=t.getAttribute("data-prefix")||"TODAY",r=t.getAttribute("data-separator")||", ",d=t.getAttribute("data-locale")||"en-US",c=t.getAttribute("data-uppercase")!=="false",s=e.getDate().toString().padStart(2,"0"),u=e.toLocaleDateString(d,{month:"short"}),p=e.getFullYear(),a=s+" "+u+" "+p;c&&(a=a.toUpperCase()),t.textContent=n+r+a})}document.addEventListener("nav",()=>{o()});document.addEventListener("render",()=>{o()});
`;
var l;
...
var Today_default = ((userOpts) => {
  ...
  const Today = ({ displayClass }) => {
    ...
    return /* @__PURE__ */ u2("div", { class: `today-component ${opts.className} ${displayClass ?? ""}`.trim(), children: /* @__PURE__ */ u2(
      "span",
      {
        class: "today-badge",
        "data-today": "true",
